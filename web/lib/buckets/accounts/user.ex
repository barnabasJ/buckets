defmodule Buckets.Accounts.User do
  ...
  authentication do
    tokens do
      ...
      signing_secret Buckets.Secrets
    end
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Buckets.Accounts.User.Senders.SendPasswordResetEmail
        end
      end
    end
    ...
    add_ons do
      confirmation :confirm_new_user do
        ...
        sender Buckets.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end
  end
