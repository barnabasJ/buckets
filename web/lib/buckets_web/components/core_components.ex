defmodule BucketsWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "rounded-lg bg-zinc-900 px-3 py-2 hover:bg-zinc-700 phx-submit-loading:opacity-50",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BucketsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BucketsWeb.Gettext, "errors", msg, opts)
    end
  end
