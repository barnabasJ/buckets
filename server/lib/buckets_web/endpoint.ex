defmodule BucketsWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_buckets_key",
    signing_salt: "anZie28k",
    same_site: "Lax"
  ]

  socket "/live", Phoenix.LiveView.Socket, websocket: [connect_info: [session: @session_options]]

  # Socket used for GraphqlSubscription
  socket "/socket", BucketsWeb.UserSocket,
    websocket: true,
    longpoll: false
  ...
  plug Plug.Static,
    ...
    from: :buckets,
    gzip: false,
    only: BucketsWeb.static_paths()

  # Code reloading can be explicitly enabled under the
  # :code_reloader configuration of your endpoint.
  if code_reloading? do
    plug Phoenix.CodeReloader
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :buckets
  end
